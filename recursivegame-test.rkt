...
(define WORLD-SPAWN-TIME (* 3 PERIOD1))
...
(define (initialize-world frame)
  ...
  (define obstacles0 '())
  (list (world box0 obstacles0 frame 1 (timers ARM-TIME OBSTACLE-SPAWN-TIME WORLD-SPAWN-TIME))))
...
(define (render-game worlds)
  ...
  (place-images (get-all get-images worlds)
...
(define (update-worlds worlds)
  ...
  (for/list ([w worlds]
    ...
    (define updated-world
      (world
       (update-box (world-box w) (frame 1 2 3))
...
(define (reset-obstacle-arm timers)
  (timers ARM-TIME (random (round OBSTACLE-SPAWN-TIME)) (timers-spawn-world timers)))
