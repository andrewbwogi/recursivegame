...
(define test-obstacle-updated (list (obstacle 894.5 892.0 897.0 5 35 1.5 45)))
(define test-obstacles-updated (list (obstacle 692.0 689.5 694.5 5 35 1.5 45) (obstacle 894.5 892.0 897.0 5 35 1.5 45)))
(define test-gone-obstacle-updated (list (obstacle 894.5 892.0 897.0 5 35 1.5 45)))
(define test-obstacle-under (list (obstacle half-x-screen (- half-x-screen 2) (+ half-x-screen 2) 5 35 1.5 45)))
